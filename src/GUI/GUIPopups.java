...
public class GUIPopups {
	...
	public GUIPopups(ConversationContainer conversationContainer, Pane conversationViewer,
	...
	public void newConversation() {
		...
		sendButton.setOnAction((event) -> {
			toConversationSendButton(ipTextField.getText(), nameTextField.getText(), popup);
		});
	...
	public void toConversation() {
		...
		addFile.setOnAction((event) -> {
			addFileButton(selectedConversation, messages);
		});

		Button sendMessage = new Button();
		sendMessage.setText("Send!");
		sendMessage.setOnAction((event) -> {
			conversationSendButton(writeMessagesHere, selectedConversation, messages);
		});
	...
	private void conversationSendButton(TextField writeMessagesHere, Conversation selectedConversation, VBox messages) {
	...
	private void addFileButton(Conversation selectedConversation, VBox messages) {
		try {
	...
	private void toConversationSendButton(String ip, String name, Stage popup) {
